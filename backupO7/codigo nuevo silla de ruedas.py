...
class MCC(QMainWindow):
    def __init__(self,file_name):
        ...
        self.ESP_IP = "http://192.168.1.106"


        self.initUI()

    def control_motor(self,motor, action):
        url = f"{self.ESP_IP}/motor"
    ...
    def funcion_derecha(self):
        self.control_motor("1", "backward")
        self.control_motor("2", "stop")

    def funcion_izquierda(self):
        self.control_motor("1", "stop")
        self.control_motor("2", "backward")
    ...
    def funcion_atras(self):
        self.control_motor("1", "forward")
        self.control_motor("2", "forward")
