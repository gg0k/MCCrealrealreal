...
class Scope(QWidget):
    ...
    def __init__(self, port=None):
        ...
        self.lowpass_slider = Slider(0, 150, 25)
        ...
        self.notch_slider = Slider(0, 50, 25)
        ...
        # Codigo para viewer, necesita lista de datos
            ...
            file_name = '1907_1108_mas abajo 100k gel posi der.txt'
...
if __name__ == "__main__":
    ...
    puerto = 'COM6'  # None para viewer, COMx para lectura
